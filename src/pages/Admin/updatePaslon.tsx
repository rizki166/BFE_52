...
function UpdatePaslon() {
  ...
  const [formData, setFormData] = useState({
    ...
    name: "",
    visiMisi: "",
    koalisi: "" // Tambahkan koalisi ke state formData
  });
  ...
  const handleSubmit = async () => {
    try {
      const { nomerUrut, name, visiMisi, koalisi } = formData; // Ambil koalisi dari state formData
      const newData = { nomerUrut, name, visiMisi, koalisi }; // Sertakan koalisi dalam payload
      ...
      if (response.ok) {
        ...
        setFormData({
          ...
          name: "",
          visiMisi: "",
          koalisi: "" // Kosongkan nilai kolom koalisi setelah submit berhasil
        });
        navigate('/listpaslon');
      } else {
      ...
      <header>
        ...
        <section className="flex justify-center gap-10 pb-10">
          ...
          <div className="flex flex-col w-4/12">
            ...
            <label className="font-bold text-gray-600">Koalisi</label>
            <input
              type="text"
              name="koalisi"
